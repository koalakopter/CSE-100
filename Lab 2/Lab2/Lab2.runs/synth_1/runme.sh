...
HD_PWD='C:/Users/Julian/Documents/Work/CSE 100/Lab 2/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carryAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carryAdder.tcl
