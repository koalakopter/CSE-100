...
HD_PWD='C:/Users/Julian/Documents/Work/CSE 100/Lab 2/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carryAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carryAdder.tcl -notrace
