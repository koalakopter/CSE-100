...
HD_PWD='C:/Users/Julian/Documents/Work/CSE 100/Lab 1/Lab 1/Lab 1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleGates.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simpleGates.tcl -notrace
