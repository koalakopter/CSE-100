...
HD_PWD='C:/Users/Julian/Documents/Work/CSE 100/Lab 1/Lab 1/Lab 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleGates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpleGates.tcl
